...
- **Shell Nomenclature:** The second diagram shows a cross-section of an atom with labeled shells:
    - **n=1:** K Shell
    - **n=2:** L Shell
    - **n=3:** M Shell
    - **n=4:** N Shell
...
- **Nucleus:** Contains 18 protons and 22 neutrons.
- **Electron Distribution:**
    - **K shell:** 2 electrons
    - **L shell:** 8 electrons
    - **M shell:** 8 electrons
- Total electrons = 18, matching the atomic number of Argon.

---

## Slide 24

### **Limitations/Applications of Bohr Model**
