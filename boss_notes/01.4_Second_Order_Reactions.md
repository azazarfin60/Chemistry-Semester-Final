...
### 🎯 Derive an expression for the rate constant of a second order reaction (both types). Also find its mathematical properties.
> **Appeared:** 2020 Q.4(b) · 2019 Q.6(a) · 2018 Q4(a) · 2017 Q5(a) — (04–08 marks)

**Answer:**

**Definitions (for combined questions like 2019):**
...
$$kt = \frac{1}{a - x} - \frac{1}{a} = \frac{a - (a - x)}{a(a - x)} = \frac{x}{a(a - x)}$$
